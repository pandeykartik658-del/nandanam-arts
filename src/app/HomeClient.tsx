  ...
  return (
    <div className="noise-overlay min-h-screen relative overflow-hidden">
      ...
      <motion.section
        ref={heroRef}
        style={{ y: heroY }}
        className="min-h-[70vh] sm:min-h-screen flex flex-col items-center justify-center text-center px-6 relative pt-24 sm:pt-0"
      >
      ...
      <section id="philosophy" className="max-w-[1100px] mx-auto px-6 pt-16 sm:pt-20 pb-20">
        ...
        >
          <p className="font-body text-lg md:text-xl leading-[1.8] mb-4" style={{ color: '#ffffff', fontWeight: 500, textShadow: '0 0 1px rgba(255, 255, 255, 0.5), 0 0 2px rgba(255, 255, 255, 0.3)' }}>
      ...
      <section id="heritage" className="max-w-[800px] mx-auto px-6 py-16 text-center">
        ...
        <p className="font-body text-lg md:text-xl leading-[1.8] mb-16" style={{ color: '#ffffff', fontWeight: 500, textShadow: '0 0 1px rgba(255, 255, 255, 0.5), 0 0 2px rgba(255, 255, 255, 0.3)' }}>
